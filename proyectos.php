    ...
    <main class="container">
        ...
        <div class="row pb-4">
            ...
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 px-0">
                        <img src="images/abmclientes.png" alt="clientes" class="img-fluid">
                    </div>
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-6 text-center">
                            <a  class="cof"href="">Código fuente</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 px-0">
                        <img src="images/abmventas.png" alt="ventas" class="img-fluid">
                    </div>
            ...
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 px-0">
                        <img src="images/proyecto-integrador.png" alt="ventas" class="img-fluid">
                    </div>
